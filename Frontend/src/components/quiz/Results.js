...
class Results extends Component{
  ...
  render() {
    ...
    return(
      <div>
        <div className="well">
          <h4> Respondiste {this.props.score} de {this.props.questions.length} Correctamente </h4>
          <h1>{percent}% - {message}</h1>
          <hr />
          <center><Link to= '/home' className="btn btn-default btn-success">Volver al inicio</Link></center>
        </div>
        <div id="solutions">
          {
